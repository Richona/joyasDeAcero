                    ...
                    <li className="topBar_section5_subMenuLi" key={index}>
                        {(props.name === "PLATA" || props.name === "ACERO") ?
                            <Dropdown as={ButtonGroup} drop={"end"} className="topBar_section5_subMenuDropdown">
                                <Link to={`/productos/catalogo/${props.name}/${sub}`}><Button variant="secondary" className="topBar_section5_button topBar_section5_subMenubutton">{sub}</Button></Link>
                                ...
                                <Dropdown.Menu className="topBar_section5_Menu">
                                    {subSubNameToArray.map((subSub, index) => (
                                        
                                            <Dropdown.Item className="topBar_section5_Menu_item" key={index} eventKey={index}>
                                                <Link to={`/productos/catalogo/${props.name}/${sub}/${subSub}`}>{subSub}</Link>
                                            </Dropdown.Item>
                            ...
                            :
                                ...
                                <Dropdown.Item className="topBar_section5_Menu_item" key={index} eventKey={index}>
                                    <Link to={`/productos/catalogo/${props.name}/${sub}`}>{sub}</Link>
                                </Dropdown.Item>
